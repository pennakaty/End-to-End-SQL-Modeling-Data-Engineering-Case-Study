...
🚀 How to Use
Deploy Schema: Run the Retail_database.sql script to build the tables and relationships.

Generate Data: Populate the database with 200+ simulated transactions:
